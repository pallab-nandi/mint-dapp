                ...
                <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                  <div className="sm:flex sm:items-start">
                    ...
                    <div className="mt-3 text-center sm:ml-4 sm:mt-5 sm:text-left">
                      <Dialog.Title
                        as="h3"
                        className="text-2xl font-semibold leading-6 text-blue-700"
                      >
                        You are eligible for Stage 2!
                      </Dialog.Title>
                    </div>
                  </div>
                </div>
                <div className="bg-blue-200 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                  <button
                    type="button"
